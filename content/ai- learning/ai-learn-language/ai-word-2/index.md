...
我需要先输入单词，获取到bank的所有含义后（大概十几，二十多种），然后逐一进行查阅，然后带着以上含义回到句子，因为有deposit my paycheck（将我的工资存入），所以我确定这里应该是银行的意思。


而在[ChatGPT](https://chat.openai.com/)出现后，步骤会简单和直观得多，通常就只是两步：
...
<div class="mermaid-hint">💡 ChatGPT查词只需3个步骤</div>
</div>
...
<div class="mermaid-hint">💡 对比：传统词典8步 vs AI查词3步。</div>
</div>

AI帮助我们跳过了中间阅读所有含义和确定准确含义的步骤，直接获得我们想要的结果，不用多说也知道哪一种方式更加省心省力。

## 为什么建议使用AI来代替你的传统查词方式

你认为会下意识认为因为AI查词更加方便，效率更高，但这还不只是效率问题，更根本的原因在于：

**当我们查单词时，我们需要的不是单词的所有含义，而是单词在句子中的含义**。

在传统词典中，我们只能输入单词，然后输出单词的所有含义，但这并不是我们想要的最终结果，我们还需要对词典给出的结果再额外进行处理，也就是代入进句子看哪一个含义才是最合适的。

而许多常见单词都存在有几十种含义，比如make，对于非母语者来说，需要消耗大量时间和心力来阅读和确定最后的准确含义，而且还会导致我们在阅读时总是需要分心来使用传统查词方式来查词，非常影响我们的阅读体验。
...
但即使只是收录常见含义，也已经足够巨大，我有一本《陆谷孙英汉大词典》，大概得有七八块砖头叠起来那么大，但即使如此，我在翻译时仍然无法找到对应的翻译，往往只能去寻求母语使用者的帮助。

还有一种情况，那就是**许多词汇只有在具体的上下文语境才能真正得到准确的含义**，而词典只能输入词汇，无法输入上下文，从根本上词典就无法解决这个问题。

在过去没有选择和对比时，传统词典似乎是唯一可行且有效的选择，但在当今这个词语含义成指数级增长的时代，传统词典就像一台早已性能落后的电脑，追不上更新迭代，已经远远带不动如今查询单词所需要的功能和性能了.
...
我的答案是，这实际上取决于许多因素；像如果是对于史料，你最好不要相信任何AI给出的结果，这不是它的功能，它不是搜索引擎；但如果是解释单词词汇的含义，用来学习语言，它可以是当今世界上最好用的工具。

当然从理论上来说，我们应该保持质疑，ChatGPT也始终强调它给出的含义可能是错误的；但从我这近一年多的使用体验上来看，如果输出单词的同时输入单词所在的句子，那输出的正确率达到非常惊人的百分之百。

ChatGPT完全正确解释了所有我在外语阅读中的英语词汇，没错，是所有。
...
在学会使用ChatGPT查询单词后，我几乎就再也没用过传统词典来查字典了，但ChatGPT用久了我又发现了一些新问题。

相比传统词典，使用ChatGPT确实又直观又准确了，但是这整个流程还是太麻烦，因为每次都需要将单词和句子复制，粘粘到ChatGPT。

如果只是一两次还好，但一篇文章中通常会有很多个需要查询的单词和句子，如果每次都这样复制粘贴，在ChatGPT和阅读界面之间切换，浪费时间不说，也非常影响我的阅读体验。于是我就想着能不能把整个流程缩短为最为简单的步骤：

1. 鼠标选取单词，同时获取到单词所在的上下文句子

2. 使用ai获取单词在句子中的含义

3. 一键添加到[Anki](https://apps.ankiweb.net/)中复习
