...
deploy_cloudflare_pages() {
    ...
    if [ "$SETUP_ACTIONS" = "y" ] || [ "$SETUP_ACTIONS" = "Y" ]; then
        ...
        echo ""
        echo "3️⃣  选择模板："
        echo "   找到 'Cloudflare Pages' 模板"
        echo "   点击 'Edit Cloudflare Pages' 右侧的 'Use template' 按钮"
        echo ""
        echo "4️⃣  配置权限（默认配置即可）："
        ...
        echo ""
        echo "6️⃣  点击页面底部的 'Continue to summary' 按钮"
        echo ""
        echo "7️⃣  确认信息后，点击 'Create Token' 按钮"
        echo ""
        echo "8️⃣  ⚠️  重要：复制显示的Token（只会显示一次！）"
        echo ""
        echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
        echo ""
